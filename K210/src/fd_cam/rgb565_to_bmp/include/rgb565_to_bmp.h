#ifndef _RGB565_TO_BMP_H_
#define _RGB565_TO_BMP_H_
...
{
	BitMapFileHeader BMPHead;	//定义文件头
	BitMapInfoHeader BMIHead;	//定义信息头
	RgbQuad RgbQuadClr[3];		//定义调色板
	uint16_t *frame_buf;
}__attribute__((packed)) FALL_BMP_File;

int Rgb565ConvertBmp(char *buf,int width,int height, FALL_BMP_File *file);

#endif // !_RGB565_TO_BMP_H_