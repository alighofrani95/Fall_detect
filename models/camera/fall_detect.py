...
def CNN(inputs):
    x0 = Conv2D(32, (3, 3), padding='same', activation="relu")(inputs)
    x0 = Conv2D(32, (3, 3), padding='same', activation="relu")(x0)
    x0 = MaxPool2D(pool_size=(2, 2))(x0)
    x0 = Conv2D(64, (3, 3), padding='same', activation="relu")(x0)
    x0 = Conv2D(64, (3, 3), padding='same', activation="relu")(x0)
    x0 = MaxPool2D(pool_size=(2, 2))(x0)
    # x0 = Conv2D(128, (3, 3), padding='same', activation="relu")(x0)
    # x0 = Conv2D(128, (3, 3), padding='same', activation="relu")(x0)
    # x0 = Conv2D(128, (3, 3), padding='same', activation="relu")(x0)
    # x0 = MaxPool2D(pool_size=(2, 2))(x0)
    x0 = bn_relu(x0, relu="relu6")
    return x0
...
def FDC(out_channels):
    ...
    x = bottleneck(x, block2_out_channels)
    ...
    outputs = Dense(out_channels, activation="softmax")(x)
